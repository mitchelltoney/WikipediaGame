...
It was odd that the bidirectional search took 24 seconds to find a path from *Kitten* to *Germany*, which was about the same performance as the original search algorithm, but for the vast majority of other search paths it was much faster.
